                ...
                <form action="<?= route_to('siswa_save'); ?>" method="post" class="form p-4">
                    ...
                    <div class="row d-flex justify-content-between">
                        <div class="col--md-2 col-sm-3 col-12 mb-3">
                            <label for="nis">Nis <span class="text-danger" style="font-size:100%">*</span></label>
                        ...
                        <div class="col-sm-8 col-12 mb-3 d-flex justify-content-between">
                            <div class="col-7">
                                <label for="nama">Nama Lengkap <span class="text-danger" style="font-size:100%">*</span></label>
                    ...
                    <!-- row -->
                    <div class="row d-flex justify-content-between align-items-end">
                        <label class="text-danger" style="font-size:80%">* Wajib diisi</label>
                    </div>
                    <!-- row -->
