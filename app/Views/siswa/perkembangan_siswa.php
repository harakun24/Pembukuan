        ...
        <form action="<?= route_to('siswa_perkembangan_save', $siswa['siswa_nis']); ?>" class="mt-2 col-12 col-sm-6 d-flex flex-wrap justify-content-center" method="post">
            ...
            <div class="row">
                <div class=" col-12 mb-3 d-flex flex-wrap">
                    ...
                    <label>Beasiswa </label> <a onclick="tambah()" class="ml-2 btn btn-success btn-sm p-1 px-2" style="font-size: 60%;"><i class="fa fa-plus"></i></a>
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($beasiswa as $b) : ?>
                                        ...
                                        <tr>
                                            <td class="col-lg-2 col-sm-3"><?= $b['beasiswa_tahun']; ?></td>
                                            <td class="col-lg-2 col-sm-3"><?= $b['beasiswa_kelas']; ?></td>
                                            <td><?= $b['beasiswa_dari']; ?></td>
                                            <td class="col-lg-2 col-sm-3">
                                                <a class="btn btn-sm btn-success" onclick="edit(<?= $b['beasiswa_id']; ?>)" style="font-size: 60%;"><i class="fa fa-pen"></i></a>
                                                <a class="btn btn-sm btn-danger" onclick="hapus(<?= $b['beasiswa_id']; ?>)" style="font-size: 60%;"><i class="fa fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
            ...
            <div class="row d-flex justify-content-between">
                <h4 class="mb-2">Meninggalkan Madrasah</h4>
                ...
                <div class="col-12 my-2">
                    <label for="sebelum_alasan">Alasan</label>
                    <textarea class="form-control" name="siswa_alasan_meninggalkan" id="sebelum_alasan"><?= $siswa['siswa_alasan_meninggalkan']; ?></textarea>
                </div>
            </div>
            <!-- row -->

            <div class="row mt-4 d-flex justify-content-between">
                <h4 class="mb-1 mt-2">Akhir pendidikan</h4>
                <div class="col-12 my-2">
                    <label for="tamat">Tahun tamat belajar</label>
                    <input type="number" value="<?= $siswa['siswa_tamat_tahun']; ?>" class="form-control" name="siswa_tamat_tahun" id="tamat">

                </div>
                <div class="col-12 my-2">
                    <label for="sttb">STTB Nomor</label>
                    <input type="text" value="<?= $siswa['siswa_tamat_sttb']; ?>" class="form-control" name="siswa_tamat_sttb" id="sttb">
                </div>
            </div>
